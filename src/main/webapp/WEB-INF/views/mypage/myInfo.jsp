                            ...
                            <div class="card mb-4">
                             ...
                             ></span>
                                        ...
                                        <div class="row justify-content-end">
                                            <div class="col-sm-10">
                                                <button type="button" onclick="location.href='/mypage/myInfoUpdate'" class="btn btn-primary">내정보 수정하기</button>
                                                <button type="button" onclick="location.href='/mypage/updatePasswd'" class="btn btn-primary">비밀번호 수정</button>
