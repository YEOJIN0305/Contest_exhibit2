    ...
    <div class="layout-page">
      ...
      <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card-body" style="position: relative;">
                      <div class="row" style="text-align: center; margin-top: 10px;">
                        ...
                        <div class="mb-4 order-0" style="width: 50%;">
                          <div>
                            <button class="btn btn-result1 w-ans d-grid" style="margin: 0 auto">be leaning against a railing</button>
                          </div>
                        </div>
                        <div class="mb-4 order-0" style="width: 50%;">
                          <div>
                            <button class="btn btn-result1 r-ans d-grid" style="margin: 0 auto">be leaning against a railing</button>
                          </div>
                        </div>
                        <div class="mb-4 order-0" style="width: 50%;">
                          <div>
                            <button class="btn btn-result1 d-grid" style="margin: 0 auto">be leaning against a railing</button>
                          </div>
                        </div>
                        <div class="mb-4 order-0" style="width: 50%;">
                          <div>
          ...
          <!-- 끝 -->
          <a href="javascript:history.back();"><div style="text-align: center;"><input type='button' class="submit-btn" value="뒤로 가기"></div></a>
          <!-- / Content -->
