                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7" style="width: 100%;">
                        <div class="card-body" style="position: relative;">
                          <span style="position: absolute; top : 15px; right : 15px; color: #516371; font-size: 20px;" >Unit 07</span>
                          <div style="text-align: center; margin-top: 10px;">
                            <p style="font-size: 30px; font-weight: 700; padding: 0; margin: 0;">배우는 중입니다!</p>
                            <p>조급해하지 말고 풀어보세요<br>화이팅!</p>

                          </div>
                          <div style="text-align: center; margin: 100px 0 20px;">
                            <span style="font-size: 35px; font-weight: 700;">18 / 20</span>
                            <span style="font-size: 20px;">(90%)</span>
                          </div>
                          <div style=" text-align:center;">
                            <a href="/quiz/quiz-workbook-check">
                              <div style="display:inline-block;zoom:1;.display:inline;"><button class="btn btn-result1 d-grid" style="">오답 확인</button></div>
                            </a>
                            <a href="/quiz/quiz-workbook">
                              <div style=" display:inline-block;zoom:1;.display:inline;"><button class="btn btn-result2 d-grid">다시 풀기</button></div>
                            </a>
                          </div>
                        </div>
                      </div>
