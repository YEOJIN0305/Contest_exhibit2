                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7" style="width: 100%;">
                        <div class="card-body" style="position: relative;">
                          <img style="position: absolute; top : 5px; right : 10px; width: 50px;" src="/assets/img/icons/aducator/bookmark.png" alt="북마크">
                          <span>뜻</span>
                          <img style="width: 20px;" src="/assets/img/icons/aducator/voice.png" alt="뜻">
                          <p style="font-size: 30px; font-weight: 700;"> be placed in a row </p>
                          <p style="font-size: 20px; font-weight: 400;">일렬로 배치되어 있다.</p>
                          <span style="position: absolute; bottom : 15px; right : 15px; ">Unit 07</span>
                        </div>
                      </div>
                    </div>
                  </div>
