          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row" style="justify-content: center">
                <p class="q-count">객관식 문제 n개</p>
                <% for (int i = 0; i < 4; i++) {%>
                <div class="col-lg-8 mb-4 order-0" style="width: 80%;">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7" style="width: 100%;">
                        <div class="card-body" style="position: relative;">
                          <div class="row" style="text-align: center; margin-top: 10px;">
                            <p class="q-text">난간에 기대어 있다.</p>

                            <div class="mb-4 order-0" style="width: 50%;">
                              <div>
                                <input type="button" class="btn btn-result1 d-grid ClkBtn" value="be leaning against a railing" style="margin: 0 auto" />
                              </div>
                            </div>
                            <div class="mb-4 order-0" style="width: 50%;">
                              <div>
                      ...
                      <div class="col-sm-7" style="width: 100%;">
                        <div class="card-body" style="position: relative;">
                          <div class="row" style="margin-top: 10px;">
                            <ul class="ul-half clear">
                              <li>
                                <div>
                                  <span style="display: inline-block; padding: 0;">뜻</span>
                                  <img style="height: 20px; width: 20px; padding: 0;" src="/assets/img/icons/aducator/voice.png" alt="voice">
                                </div>
                                <p>명심하다</p>
                              </li>
                              <li>
                                <div>
                                  <span style="display: inline-block; padding: 0;">단어</span>
                                  <img style="height: 20px; width: 20px; padding: 0;" src="/assets/img/icons/aducator/voice.png" alt="voice">
                                </div>
                                <p>financial</p>
                              </li>
                            ...
                            <div class="mb-4 order-0" style="width: 50%;">
                              <div>
                                <input type="button" class="btn btn-result1 d-grid" style="margin: 0 auto" value="맞음" />
                              </div>
                            </div>
                            <div class="mb-4 order-0" style="width: 50%;">
                              <div>
                                <input type="button" class="btn btn-result1 d-grid" style="margin: 0 auto" value="틀림" />
                              </div>
                            </div>
                      ...
                      <div class="col-sm-7" style="width: 100%;">
                        <div class="card-body" style="position: relative;">
                          <div class="row" style=" margin-top: 10px;">
                            ...
                            <div class="mb-4 order-0" style="width: 100%;">
                              <div style="margin: 0 auto; text-align: center; align-items: center;" >
                                <input type="text" class="btn-result1" placeholder="정답 입력"/>
                              </div>
                            </div>
              ...
              <!-- 끝 -->
              <div style="text-align: center;"><input type='submit' class="submit-btn" value="결과 보기"></div>
            <!-- / Content -->
