            ...
            <div class="card" style=" border-radius: 100px;">
                <div class="card-body pad-style">
                    ...
                    <a class="menu-link">
                        ...
                        <div data-i18n="Account Settings"><h3><strong>&nbsp;<%=uDTO.getUser_name()%></strong></h3></div>
                    </a>
                    ...
                    <ul class="p-0 m-0">
                        <li class="d-flex mb-4 pb-1" style="border-bottom: 1px solid #d9dee3;">
                            <form>
                                <div class="user-name">
                                    이름 : <input type="text" readonly value="<%=uDTO.getUser_name()%>" />
                                </div>
                                <div class="user-name">
                                    아이디 : <input type="text" readonly value="<%=uDTO.getUser_id()%>" />
                                </div>
                                <div class="user-name">
                                    이메일 : <input type="email" readonly value="<%=uDTO.getUser_email()%>" />
                                </div>
                                <div class="user-name">
                                    나이 : <input type="email" readonly value="<%=uDTO.getAge()%>" />
                                </div>
                                <div class="user-name">
                                    성별 : <input type="email" readonly value="<%=uDTO.getSex()%>" />
                                </div>
                            </form>
                        </li>
                    </ul>
