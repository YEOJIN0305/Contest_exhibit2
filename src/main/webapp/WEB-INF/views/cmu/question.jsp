...
<%@ page import="kopo.poly.dto.QuestionDTO" %>
    ...
    <div class="layout-container">
        ...
        <div class="layout-page">
            ...
            <div style="align-items: center">
                ...
                <button type="button" class="btn btn-xl btnselect" onclick="location.href = '/cmu/question'"
                        ...
                        <table class="table" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td><i class="fab fa-angular fa-lg text-danger me-3"><a
                                        href="/cmu/Cmu_03?no=<%=qList.get(i).getNotice_seq()%>"><%=qList.get(i).getTitle()%>
                                </a></i></td>
                                <td><%=qList.get(i).getUser_seq()%>
                                </td>
                                <td><%=qList.get(i).getNotice_date().substring(0,10)%>
                                </td>
                            </tr>
