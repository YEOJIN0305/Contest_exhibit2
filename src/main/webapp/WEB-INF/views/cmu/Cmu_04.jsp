    ...
    <div class="layout-container">
        ...
        <div class="layout-page">
            ...
            >
                ...
                <div><h1><strong>게시글 수정</strong></h1></div>
            ...
            <div style="margin: 0 auto; max-width: calc(1440px - calc(1.625rem * 2)); width: calc(100% - (1.625rem * 2));">
                <div class="container" style="min-width: 100%;">
                    <form action="/DoCmuUpdate" method="get">
                        <div class="form-group">
                            <input name="title" type="text" value="<%=CmmUtil.nvl(rDTO.getTitle())%>" style="width: 60%; height: 50px; display: flex; align-items: center; margin-left: 0; margin-top : 2%; color: gray"/></input>
                        </div>
                        <br>
                        ...
                        <br>
                        <div class="form-group">
                            <textarea name="contents" style="width: 100%; height: 500px; display: flex; align-items: center; margin-left: 0; margin-right: 0.5%;"/><%=CmmUtil.nvl(rDTO.getContents())%></textarea>
                        </div>
                        <div style="width: 100%; text-align: right; margin-top: 5px; color: gray">
                            <button type=submit class="btn btnback" onclick="location.href = 'Cmu_03.jsp'" style="margin-right: 15px">취소</button>
                            <button type=submit class="btn btnok" onclick="location.href = 'Cmu_04.jsp'">수정</button>
                        </div>
                    </form>
