...
<%@ page import="kopo.poly.dto.AnnouncementDTO" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>

<%
    List<AnnouncementDTO> aList = (List<AnnouncementDTO>) request.getAttribute("aList");
    if (aList == null) {
        aList = new ArrayList<>();
    }
%>
    ...
    <div class="layout-container">
        ...
        <div class="layout-page">
            ...
            >
                ...
                <div><h1><strong>게시판</strong></h1></div>
            ...
            <div style="align-items: center">
                <button type="button" class="btn btn-xl btncmu" onclick="location.href = '/cmu/Cmu_01'"
                        style="margin-right: 2%; width: 13%"><h3><strong>전체글</strong></h3></button>
                <button type="button" class="btn btn-xl btnselect" onclick="location.href = '/cmu/announcement'"
                        style="margin-right: 2%; width: 13%"><h3>
                    <strong>공지글</strong></h3></button>
                <button type="button" class="btn btn-xl btncmu" onclick="location.href = '/cmu/question'"
                        style="margin-right: 20%; width: 20%"><h3><strong>자주묻는
                    질문</strong></h3></button>
                <button type="button" class="btn btn-xl btnwr" onclick="location.href = '/cmu/Cmu_02'"
                        style="; width: 13%">
                        ...
                        <table class="table" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td><i class="fab fa-angular fa-lg text-danger me-3"><a
                                        href="/cmu/Cmu_03?no=<%=aList.get(i).getNotice_seq()%>"><%=aList.get(i).getTitle()%>
                                </a></i></td>
                                <td><%=aList.get(i).getUser_seq()%>
                                </td>
                                <td><%=aList.get(i).getNotice_date().substring(0,10)%>
                                </td>
                            </tr>
            ...
            <!-- search -->
            <div class="card-body demo-vertical-spacing demo-only-element" style="width: 30%">
