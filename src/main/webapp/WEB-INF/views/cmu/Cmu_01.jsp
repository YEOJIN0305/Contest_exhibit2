...
<div class="layout-wrapper layout-content-navbar"
    ...
    <div class="layout-container">
        ...
        <div class="layout-page">
            ...
            <br>
            <br>
            <div style="align-items: center; max-width: calc(1440px - calc(1.625rem * 2));">
                <button type="button" class="btn btn-xl btnselect" onclick="location.href = '/cmu/Cmu_01'"
                        style="margin-right: 2%; width: 13%"><h3><strong>전체글</strong></h3></button>
                <button type="button" class="btn btn-xl btncmu" onclick="location.href = '/cmu/announcement'"
                        ...
                        <table class="table" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td><i class="fab fa-angular fa-lg text-danger me-3"><a
                                        href="/cmu/Cmu_03?no=<%=cList.get(i).getNotice_seq()%>"><%=cList.get(i).getTitle()%>
                                </a></i></td>
                                <td><%=cList.get(i).getUser_seq()%>
                                </td>
                                <td><%=cList.get(i).getNotice_date().substring(0,10)%>
                                </td>
                            </tr>
